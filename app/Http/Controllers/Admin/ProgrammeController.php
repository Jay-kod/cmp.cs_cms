...
class ProgrammeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'req_olevel' => 'nullable|string|max:500',
            'req_alevel' => 'nullable|string|max:500',
            'req_utme_subjects' => 'nullable|string|max:500',
            'req_utme_score' => 'nullable|string|max:255',
            'req_pg_core' => 'nullable|string',
            'req_pg_academic' => 'nullable|string',
