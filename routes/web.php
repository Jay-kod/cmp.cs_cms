...
Route::get('/news', [ResearchNewsController::class, 'index'])->name('research-news');
Route::get('/research-innovations', [ResearchNewsController::class, 'research'])->name('research');
Route::get('/news/{slug}', [ResearchNewsController::class, 'show'])->name('research-news.show');
Route::get('/announcements', [ResearchNewsController::class, 'announcements'])->name('announcements.index');
Route::get('/announcements/{id}', [ResearchNewsController::class, 'showAnnouncement'])->name('announcements.show');
