...
$filePath = __DIR__ . '/../resources/views/admin/page-content/about.blade.php';
        ...
        <div class="pc-card-body collapsed">
            ...
            <div id="progRepeater">
                ...
                <div class="repeater-row">
                    ...
                    <div class="form-row">
                        <div class="form-group"><label>Theme Color Main</label><input type="text" name="about_programmes[{{ \$i }}][theme_main]" value="{{ \$prog['theme_main'] ?? '#0f172a' }}"></div>
                        <div class="form-group"><label>Theme Color Accent</label><input type="text" name="about_programmes[{{ \$i }}][theme_accent]" value="{{ \$prog['theme_accent'] ?? '#1e293b' }}"></div>
                    </div>
                    <div class="form-group">
        ...
        <div class="pc-card-body collapsed">
            ...
            <div id="boardRepeater">
                ...
                <div class="repeater-row">
                    ...
                    <div class="form-group">
                        <label>Details (Who or Mandate)</label>
                        <textarea name="about_board[{{ \$i }}][who]" rows="2">{{ \$bm['who'] ?? '' }}</textarea>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="pc-card-body collapsed">
            ...
            <div id="reqRepeater">
                ...
                <div class="repeater-row">
                    ...
                    <div class="form-group"><label>Requirement Description</label><textarea name="about_requirements[{{ \$i }}][desc]" rows="2">{{ \$req['desc'] ?? '' }}</textarea></div>
                </div>
                @endforeach
            </div>
...
function addReq() {
    ...
    r.insertAdjacentHTML('beforeend', `
        <div class="repeater-row">
            ...
            <div class="form-group"><label>Requirement Description</label><textarea name="about_requirements[\${reqIdx}][desc]" rows="2"></textarea></div>
        </div>
    `);
    reqIdx++;
}
...
function addProg() {
    ...
    r.insertAdjacentHTML('beforeend', `
        <div class="repeater-row">
            ...
            <div class="form-row">
                <div class="form-group"><label>Theme Color Main</label><input type="text" name="about_programmes[\${progIdx}][theme_main]" value="#0f172a"></div>
                <div class="form-group"><label>Theme Color Accent</label><input type="text" name="about_programmes[\${progIdx}][theme_accent]" value="#1e293b"></div>
            </div>
            <div class="form-group">
                <label>List of Degrees/Programmes (One per line)</label>
...
function addBoard() {
    ...
    r.insertAdjacentHTML('beforeend', `
        <div class="repeater-row">
            ...
            <div class="form-group">
                <label>Details (Who or Mandate)</label>
                <textarea name="about_board[\${boardIdx}][who]" rows="2"></textarea>
            </div>
        </div>
    `);
    boardIdx++;
...
echo "Successfully rewrote about.blade.php\n";