...
<div style="max-width: 900px; margin: 0 auto;">
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #047857 100%); border-radius: 16px; padding: 2.5rem; color: white; display: flex; align-items: center; justify-content: space-between; box-shadow: 0 10px 25px -5px rgba(22, 163, 74, 0.4); margin-bottom: 2rem; position: relative; overflow: hidden;">
        ...
        <div style="position: relative; z-index: 10;">
            ...
            <p style="margin: 0; color: #d1fae5; font-size: 1.05rem; max-width: 500px; line-height: 1.5;">Protect your university's data. Generate a complete SQL snapshot of all records, configurations, and content safely and securely.</p>
        </div>
    ...
    <div class="admin-card" style="text-align: center; padding: 3rem 2rem; border: 2px dashed #e5e7eb;">
        ...
        <form method="POST" action="{{ route('admin.backup.download') }}">
            @csrf
            <button type="submit" style="background: #0f172a; color: white; padding: 1.1rem 2.5rem; font-size: 1.05rem; border-radius: 10px; font-weight: 600; font-family: var(--font-heading); display: inline-flex; align-items: center; gap: 12px; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); border: none; cursor: pointer; box-shadow: 0 4px 6px -1px rgba(15, 23, 42, 0.3);" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 10px 20px -5px rgba(15, 23, 42, 0.4)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 6px -1px rgba(15, 23, 42, 0.3)';">
                <i class="fa-solid fa-cloud-arrow-down" style="font-size: 1.2rem; color: var(--color-primary);"></i> 
