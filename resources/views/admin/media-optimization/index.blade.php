...
@section('content')
    ...
    <div data-aos="fade-up" class="admin-card" style="margin-bottom: 1.5rem;">
        <h2 style="margin: 0 0 0.5rem; font-size: 1.05rem;">Conversion Queue Status</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="actions" style="display: flex; justify-content: flex-start;">
                                <form action="{{ route('admin.media-optimization.requeue', $media) }}" method="POST">
                                    @csrf
                                    <button type="submit" style="background: var(--color-primary); color: white; border: none; padding: 0.55rem 0.75rem; border-radius: 6px; cursor: pointer; font-weight: 700;">
                                        Requeue
                                    </button>
                                </form>
                            </div>
