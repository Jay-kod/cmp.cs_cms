...
@php
    ...
    $navSections = [
        ...
        'sec-staff' => ['icon' => 'fa-users',   'label' => 'Staff List',   'color' => '#10b981'],
        'sec-past'  => ['icon' => 'fa-user-tie','label' => 'Past HODs',    'color' => '#f59e0b'],
    ];
@endphp
    ...
    <div class="apc-main">
        ...
        <div class="apc-section" id="sec-hero">
            <div class="apc-section-header open" onclick="toggleSection(this)">
                <div class="apc-section-header-left">
                    ...
                    <div>
                        ...
                        <p class="apc-section-subtitle">Top header banner for the people page</p>
                    </div>
                </div>
            ...
            <div class="apc-section-body">
                <div class="apc-field" style="margin-bottom: 0.9rem;">
                    ...
                    <input class="apc-input" type="text" name="people_hero_title" value="{{ $s('people_hero_title', 'Our People') }}">
                </div>
                <div class="apc-field" style="margin-bottom: 1.25rem;">
                    <label class="apc-label">Hero Subtitle (Optional)</label>
                    <textarea class="apc-textarea" name="people_hero_subtitle" rows="2">{{ $s('people_hero_subtitle', '') }}</textarea>
                </div>
                <div class="apc-field">
                    <label class="apc-label"><i class="fa-solid fa-image"></i> Hero Background Image</label>
                    <div style="display: flex; gap: 1rem; align-items: flex-end;">
                        @if($s('hero_people'))
                            <img src="{{ asset('storage/'.$s('hero_people')) }}" style="height: 60px; width: 100px; border-radius: 8px; object-fit: cover; border: 1px solid #e2e8f0;">
                        @else
                        ...
                        @endif
                        <input class="apc-input" type="file" name="hero_people" accept="image/jpeg,image/png,image/webp" style="padding: 0.4rem;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="apc-section" id="sec-staff">
            <div class="apc-section-header">
                <div class="apc-section-header-left">
                    <div class="apc-section-icon" style="background: {{ $navSections['sec-staff']['color'] }};"><i class="fa-solid {{ $navSections['sec-staff']['icon'] }}"></i></div>
                    <div>
                        <p class="apc-section-title">Staff Details</p>
                        <p class="apc-section-subtitle">Manage individual staff profiles</p>
                    </div>
                </div>
            </div>
            <div class="apc-section-body" style="text-align: center; padding: 2.5rem 1rem;">
                <i class="fa-solid fa-users fa-2x" style="color: {{ $navSections['sec-staff']['color'] }}; margin-bottom: 0.8rem;"></i>
                <h4 style="margin:0 0 0.5rem; color:#1e293b;">Managed Separately</h4>
                <p style="color:#64748b; font-size:0.85rem; margin-bottom:1.5rem;">Academic and non-academic staff profiles are managed in a dedicated directory.</p>
                <a href="{{ route('admin.staff.index') }}" style="display:inline-flex; align-items:center; gap:0.5rem; background:#1e293b; color:white; padding:0.6rem 1.5rem; border-radius:8px; font-size:0.85rem; font-weight:600; text-decoration:none;"><i class="fa-solid fa-arrow-right"></i> Manage Staff Directory</a>
            </div>
        </div>

        {{-- ── PAST HODs ── --}}
        <div class="apc-section" id="sec-past">
            <div class="apc-section-header">
                <div class="apc-section-header-left">
                    <div class="apc-section-icon" style="background: {{ $navSections['sec-past']['color'] }};"><i class="fa-solid {{ $navSections['sec-past']['icon'] }}"></i></div>
                    <div>
                        <p class="apc-section-title">Past HODs</p>
                        <p class="apc-section-subtitle">Manage history of department heads</p>
                    </div>
                </div>
            </div>
            <div class="apc-section-body" style="text-align: center; padding: 2.5rem 1rem;">
                <i class="fa-solid fa-user-graduate fa-2x" style="color: {{ $navSections['sec-past']['color'] }}; margin-bottom: 0.8rem;"></i>
                <h4 style="margin:0 0 0.5rem; color:#1e293b;">Managed Separately</h4>
                <p style="color:#64748b; font-size:0.85rem; margin-bottom:1.5rem;">The listing of past Heads of Department are managed in their dedicated section.</p>
                <a href="{{ route('admin.past-hods.index') }}" style="display:inline-flex; align-items:center; gap:0.5rem; background:#1e293b; color:white; padding:0.6rem 1.5rem; border-radius:8px; font-size:0.85rem; font-weight:600; text-decoration:none;"><i class="fa-solid fa-arrow-right"></i> Manage Past HODs</a>
            </div>
        </div>
