...
@section('title', 'Past HODs Page Content')
@section('header', 'Past HODs Page Editor')
...
@php
    ...
    $navSections = [
        ...
        'sec-list' => ['icon' => 'fa-user-tie', 'label' => 'HODs List',    'color' => '#f59e0b'],
    ];
@endphp
...
<div style="padding: 1rem; margin-top: auto; position: sticky; bottom: 0; background: white; border-top: 1px solid #e2e8f0; z-index: 10;">
    ...
    <div class="apc-main">
        ...
        <div class="apc-section" id="sec-hero">
            <div class="apc-section-header open" onclick="toggleSection(this)">
                <div class="apc-section-header-left">
                    ...
                    <div>
                        ...
                        <p class="apc-section-subtitle">Top header banner for the Past HODs page</p>
                    </div>
                </div>
            ...
            <div class="apc-section-body">
                <div class="apc-field" style="margin-bottom: 0.9rem;">
                    ...
                    <input class="apc-input" type="text" name="past_hods_hero_title" value="{{ $s('past_hods_hero_title', 'Past Heads of Department') }}">
                </div>
                <div class="apc-field" style="margin-bottom: 1.25rem;">
                    <label class="apc-label">Hero Subtitle</label>
                    <textarea class="apc-textarea" name="past_hods_hero_subtitle" rows="2">{{ $s('past_hods_hero_subtitle', 'Honoring the leaders who have driven our department forward.') }}</textarea>
                </div>
                <div class="apc-field">
                    <label class="apc-label"><i class="fa-solid fa-image"></i> Hero Background Image</label>
                    <div style="display: flex; gap: 1rem; align-items: flex-end;">
                        @if($s('hero_past-hods'))
                            <img src="{{ asset('storage/'.$s('hero_past-hods')) }}" style="height: 60px; width: 100px; border-radius: 8px; object-fit: cover; border: 1px solid #e2e8f0;">
                        @else
                        ...
                        @endif
                        <input class="apc-input" type="file" name="hero_past-hods" accept="image/jpeg,image/png,image/webp" style="padding: 0.4rem;">
                    </div>
                </div>
            </div>
        </div>
        ...
        {{-- ── HODs LIST ── --}}
        <div class="apc-section" id="sec-list">
            <div class="apc-section-header">
                <div class="apc-section-header-left">
                    <div class="apc-section-icon" style="background: {{ $navSections['sec-list']['color'] }};"><i class="fa-solid {{ $navSections['sec-list']['icon'] }}"></i></div>
                    <div>
                        <p class="apc-section-title">HODs List</p>
                        <p class="apc-section-subtitle">Manage historical records</p>
                    </div>
                </div>
            </div>
            <div class="apc-section-body" style="text-align: center; padding: 2.5rem 1rem;">
                <i class="fa-solid fa-user-graduate fa-2x" style="color: {{ $navSections['sec-list']['color'] }}; margin-bottom: 0.8rem;"></i>
                <h4 style="margin:0 0 0.5rem; color:#1e293b;">Managed Separately</h4>
                <p style="color:#64748b; font-size:0.85rem; margin-bottom:1.5rem;">The listing of past Heads of Department is managed in a dedicated directory.</p>
