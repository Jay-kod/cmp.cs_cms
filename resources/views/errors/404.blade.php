    ...
    <div class="container" data-aos="fade-up" style="max-width: 900px; margin: 0 auto; padding: 0 1rem;">
        <div style="background: white; border-radius: 16px; border: 1px solid #e5e7eb; padding: 2rem; box-shadow: 0 10px 25px rgba(0,0,0,0.04);">
            <div style="display:flex; align-items:flex-start; gap: 1.25rem; flex-wrap: wrap;">
                <div style="width: 56px; height: 56px; border-radius: 14px; background: rgba(148, 163, 184, 0.18); display:flex; align-items:center; justify-content:center; color:#475569; font-weight: 800; font-size: 1.3rem;">
                    404
                </div>
                <div style="flex: 1; min-width: 260px;">
                    <h1 style="margin: 0 0 0.5rem; color:#0f172a; font-size: 1.5rem; font-weight: 800;">Page not found</h1>
