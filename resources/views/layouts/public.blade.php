                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 2.5rem;">
                    ...
                    <div>
                        ...
                        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.55rem;">
                            <li><a href="/" style="color: #9ca3af; text-decoration: none; font-size: 0.88rem; transition: color 0.15s, padding-left 0.15s; display: inline-block;" onmouseover="this.style.color='var(--color-accent)'; this.style.paddingLeft='4px'" onmouseout="this.style.color='#9ca3af'; this.style.paddingLeft='0'"><i class="fa-solid fa-chevron-right" style="font-size: 0.6rem; margin-right: 0.4rem;"></i>Home</a></li>
                            <li><a href="/about" style="color: #9ca3af; text-decoration: none; font-size: 0.88rem; transition: color 0.15s, padding-left 0.15s; display: inline-block;" onmouseover="this.style.color='var(--color-accent)'; this.style.paddingLeft='4px'" onmouseout="this.style.color='#9ca3af'; this.style.paddingLeft='0'"><i class="fa-solid fa-chevron-right" style="font-size: 0.6rem; margin-right: 0.4rem;"></i>About Us</a></li>
                            <li><a href="/academics" style="color: #9ca3af; text-decoration: none; font-size: 0.88rem; transition: color 0.15s, padding-left 0.15s; display: inline-block;" onmouseover="this.style.color='var(--color-accent)'; this.style.paddingLeft='4px'" onmouseout="this.style.color='#9ca3af'; this.style.paddingLeft='0'"><i class="fa-solid fa-chevron-right" style="font-size: 0.6rem; margin-right: 0.4rem;"></i>Academics</a></li>
                            <li><a href="/people" style="color: #9ca3af; text-decoration: none; font-size: 0.88rem; transition: color 0.15s, padding-left 0.15s; display: inline-block;" onmouseover="this.style.color='var(--color-accent)'; this.style.paddingLeft='4px'" onmouseout="this.style.color='#9ca3af'; this.style.paddingLeft='0'"><i class="fa-solid fa-chevron-right" style="font-size: 0.6rem; margin-right: 0.4rem;"></i>Faculty</a></li>
                            <li><a href="/research-news" style="color: #9ca3af; text-decoration: none; font-size: 0.88rem; transition: color 0.15s, padding-left 0.15s; display: inline-block;" onmouseover="this.style.color='var(--color-accent)'; this.style.paddingLeft='4px'" onmouseout="this.style.color='#9ca3af'; this.style.paddingLeft='0'"><i class="fa-solid fa-chevron-right" style="font-size: 0.6rem; margin-right: 0.4rem;"></i>Blog</a></li>
                            <li><a href="/contact-nacos" style="color: #9ca3af; text-decoration: none; font-size: 0.88rem; transition: color 0.15s, padding-left 0.15s; display: inline-block;" onmouseover="this.style.color='var(--color-accent)'; this.style.paddingLeft='4px'" onmouseout="this.style.color='#9ca3af'; this.style.paddingLeft='0'"><i class="fa-solid fa-chevron-right" style="font-size: 0.6rem; margin-right: 0.4rem;"></i>Contact & NACOS</a></li>
                        </ul>
