...
<!-- Hero Section -->
<div class="about-hero" style="background: linear-gradient(135deg, rgba(30, 58, 138, 0.95) 0%, rgba(3, 105, 161, 0.90) 50%, rgba(30, 58, 138, 0.98) 100%), url('{{ $heroUrl }}') center/cover; padding: 5.5rem 0 6.5rem; position: relative; overflow: hidden;">
    <div style="position: absolute; inset: 0; background: radial-gradient(circle at 20% 80%, rgba(56, 189, 248, 0.15), transparent 50%), radial-gradient(circle at 80% 20%, rgba(34, 211, 238, 0.1), transparent 50%); pointer-events: none;"></div>
    
    <div class="container" data-aos="fade-up" style="position: relative; z-index: 10; text-align: center;">
        <div style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.4rem 1.2rem; background: rgba(255,255,255,0.1); backdrop-filter: blur(8px); color: #bae6fd; border-radius: 20px; font-size: 0.8rem; font-weight: 600; letter-spacing: 1.5px; text-transform: uppercase; margin-bottom: 1.5rem; border: 1px solid rgba(255,255,255,0.1);">
        ...
        <p style="color: #e0f2fe; font-size: 1.15rem; max-width: 680px; margin: 0 auto; line-height: 1.7;">Your complete departmental guide to industrial placement, logging, and evaluation.</p>
    </div>
</div>
