        ...
        <section data-aos="fade-up" id="vision-mission" class="mb-16">
            ...
            <div class="mt-8 mb-16 relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 relative">
                    ...
                    <div class="text-center py-10 px-6 sm:px-8 bg-white rounded-[1.5rem] transition-transform duration-300 hover:-translate-y-2 flex flex-col items-center" style="border: none; box-shadow: 0 25px 60px -12px rgba(22, 101, 52, 0.35);">
        ...
        <section data-aos="fade-up" id="departmental-board" class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-[#0f5f3c] rounded-[1.5rem] p-10 text-center flex flex-col items-center justify-center h-full transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <h4 class="m-0 mb-3 text-[1.2rem] font-bold text-[#4ade80]" style="text-align: center !important; display: block; width: 100%;">{{ $bm['title'] ?? '' }}</h4>
                    <p class="m-0 text-[#a7f3d0] text-[0.95rem] leading-[1.5]" style="text-align: center !important; display: block; width: 100%;">{!! nl2br(e($bm['who'] ?? '')) !!}</p>
                </div>
                @else
                <!-- Members / Mandate -->
                <div class="bg-[#f0fdf4] rounded-[1.5rem] p-10 text-center flex flex-col items-center justify-center h-full transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <h4 class="m-0 mb-3 text-[1.2rem] font-extrabold text-slate-900" style="text-align: center !important; display: block; width: 100%;">{{ $bm['title'] ?? '' }}</h4>
                    <p class="m-0 text-slate-500 text-[0.95rem] leading-[1.6]" style="text-align: center !important; display: block; width: 100%;">{!! nl2br(e($bm['who'] ?? '')) !!}</p>
                </div>
                @endif
                @endforeach
            </div>
