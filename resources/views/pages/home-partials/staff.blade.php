...
<section data-aos="fade-up" class="py-24 bg-[#f4fcfa] relative overflow-hidden">
    ...
    <div class="container relative z-10" data-aos="fade-up">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <a href="{{ route('people.show', $member->slug) }}" class="group block bg-white rounded-[2rem] p-3 sm:p-4 border-2 border-primary/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:border-primary/30">
