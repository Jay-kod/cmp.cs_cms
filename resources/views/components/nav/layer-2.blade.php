            ...
            <nav class="navbar-nav desktop-only hidden lg:flex items-center justify-end gap-6 flex-1" id="primary-nav">
                ...
                <details class="nav-dropdown relative group">
                    ...
                    <div class="nav-dropdown-menu absolute top-[calc(100%+15px)] left-1/2 -translate-x-1/2 bg-white shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-2px_rgba(0,0,0,0.05)] rounded-lg p-2 min-w-[250px] z-50 border border-gray-100" role="menu">
                        ...
                        <a href="{{ route('announcements.index') }}" class="nav-dropdown-item  block py-2.5 px-4  text-[0.95rem]  no-underline rounded-md transition-all duration-200 hover:bg-green-50 hover:text-primary {{ request()->routeIs('announcements*') ? 'bg-green-50 text-primary font-bold shadow-sm' : 'text-gray-600 font-medium' }}" role="menuitem">Announcements</a>
        ...
        <div class="mobile-drawer-content">
            ...
            <details class="mobile-details">
                ...
                <div class="mobile-details-menu">
                    ...
                    <a href="{{ route('announcements.index') }}" class="mobile-link mobile-sub-link {{ request()->routeIs('announcements*') ? 'text-primary font-bold bg-green-50 border-l-4 border-primary pl-3' : '' }}">Announcements</a>
